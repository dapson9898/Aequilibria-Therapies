...
const SERVICES = [
  {
    ...
    img: 'https://images.unsplash.com/photo-1555252333-9f8e92e65df9?w=600&q=80', flip: false,
    ...
    expect: "Your first session includes a comprehensive consultation. Treatment lasts 45–60 minutes. Most patients feel minimal discomfort and many experience deep relaxation.",
    btn: 'Book Acupuncture Session',
  },
  {
    icon: <Leaf size={26} />, title: 'Naturopathy', subtitle: "Nature's Path to Wellness",
    img: 'https://images.unsplash.com/photo-1498837167922-ddd27525d352?w=600&q=80', flip: true,
  ...
  },
  {
    ...
    img: 'https://images.unsplash.com/photo-1581595220892-b0739db3ba8c?w=600&q=80', flip: false,
  ...
  },
  {
    ...
    img: 'https://images.unsplash.com/photo-1544161515-4ab6ce6db874?w=600&q=80', flip: true,
  ...
  },
  {
    ...
    img: 'https://images.unsplash.com/photo-1506126613408-eca07ce68773?w=600&q=80', flip: false,
  ...
  },
  {
    ...
    img: 'https://images.unsplash.com/photo-1499209974431-9dddcece7f88?w=600&q=80', flip: true,
      ...
      <section className="section-pad bg-light">
        <div className="container">
          ...
          <div className="integrated-card">
            <p>At Aequilibria Therapies we understand that true healing requires addressing all aspects of your being. That's why we offer six complementary healing modalities that work synergistically to restore balance and vitality.</p>
