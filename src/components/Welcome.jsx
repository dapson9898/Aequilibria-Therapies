        ...
        <>
            <div className="welcome">
                <div className="welc-text">
                    ...
                    <p>Where ancient wisdom meets modern healing. We are a licensed medical company specializing in comprehensive holistic treatments designed to restore balance and promote natural wellness.</p>
                    ...
                    <p>Experience the difference of personalized, compassionate care in a serene, professional environment.</p>
                </div>
